...
function submitLeadFormHomePage(selector) {
  ...
  const data = {
    ...
    est_time: $(`.${selector} .est_time`).val(),
  ...
  $.ajax({
    ...
    error: function (error) {
      ...
      handleFormError(error.responseJSON.error);
    },
    complete: function (data) {
...
/*
$('.section-form-div .name').val('anshu')
$('.section-form-div .address').val('demo test address')
$('.section-form-div .postal_code').val('877689')
$('.section-form-div .city').val('pune')
$('.section-form-div .last_name').val('priyam')
$('.section-form-div .mobile_num').val('8978787878')
$('.section-form-div .email').val('rishavbeas@gmail.com')
$('.section-form-div .password').val('12345678')
$('.section-form-div .confirm_password').val('12345678')
$('.section-form-div .country').val('231')
$('.section-form-div .state').val('3953')
$('.section-form-div .language').val('en')
$('.section-form-div .opportunity_name').val('testing oppurtunity')
$('.section-form-div .est_time').val('2025-02-25')
$('.section-form-div .best_time').val('16:23')
$('.section-form-div .detail_description').val('This is for TESTING purposes ONLY')
...
city:pune
last_name:priyam
mobile_num:8978787878
email:rishavbeas@gmail.com
password:12345678
country:231
state:3953
language:en
opportunity_name:testing oppurtunity
est_time:2025-01-25T18:23
best_time:16:23
detail_description:This is for TESTING purposes ONLY
*/
