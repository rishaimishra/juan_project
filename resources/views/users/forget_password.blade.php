...
<section>
      <div>
        <section class="text-center bg_color login_section">
          <h3 class="white fz36 mb-0 font_bold">{{__('lang.forget_password')}}</h3>
        </section>
                  ...
                  <div class="row">
                    <div class="col-md-6 col-12">
                      <div class="form-group">
                        ...
                        <input class="form-control pl-4 pr-4 input_bg border_radius custom_input" name="email" type="text" required placeholder="Enter email" />
                      </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary">{{__('lang.send')}} {{__('lang.text_email')}}</button>
                    </div>
                  </div>
              </div>
            </form>
