    ...
    <section>
        <div>
            ...
            <div class="login_form p-5 font_bold c-form">
                <form action="{{ route('auth.login.contractor') }}" method="POST">@csrf
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="col-form-label input_color fz16 pt-3">{{ __('Password') }}</label>
                                    <input class="form-control pl-4 pr-4 input_bg border_radius custom_input"
                                        name="password" type="password" placeholder="Enter Password" />
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <button type="submit" class="btn btn-primary">{{ __('lang.text_acceder') }}</button>
                            </div>
                            <div class="col-md-6">
